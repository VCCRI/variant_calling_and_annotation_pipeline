...
for infile in "${indir}"/*.chromM.helixmtdb.mitimpact.mitotip.mitomap."${genome_version}"_multianno.vcf; do
...
./mitochondria_1e_convert_to_tsv_SubmitJobs.sh $out_manifest
