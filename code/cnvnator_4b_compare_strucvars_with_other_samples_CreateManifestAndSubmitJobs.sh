...
database_file=/my/directory/variant_calling_and_annotation_pipeline/code/databases/database.cnvnator.allVars.txt
...
for infile in "${indir}"/*.cnvnator.filter.CDSx.Gene.bndX.gCDSx.gGene.gBndX.EHRF.gSV.DGV.Dup.dbsc.TSS.pext.Idel.Ishort.gIshort.hot.collapsed.tsv; do
...
./cnvnator_4b_compare_strucvars_with_other_samples_SubmitJobs.sh $out_manifest
