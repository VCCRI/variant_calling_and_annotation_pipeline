...
outdir=/my/directory/variant_calling_and_annotation_pipeline/working_directory/gvcf
...
echo ''
echo 'Now run the following, which will submit multiple jobs for each sample due to multiple chromosomes:'
echo ''
echo './callVar_1_gvcf_EntryPoint.sh' $out_manifest
echo ''

#./callVar_1_gvcf_EntryPoint.sh $out_manifest
