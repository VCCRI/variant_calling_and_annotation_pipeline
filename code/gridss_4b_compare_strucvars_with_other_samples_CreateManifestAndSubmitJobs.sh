...
database_file=/my/directory/variant_calling_and_annotation_pipeline/code/databases/database.gridss.allVars.txt
...
for infile in "${indir}"/*.gridss.CDSx.Gene.bndX.gCDSx.gGene.gBndX.EHRF.gSV.DGV.Dup.dbsc.TSS.pext.Idel.Ishort.gIshort.hot.collapsed.tsv; do
