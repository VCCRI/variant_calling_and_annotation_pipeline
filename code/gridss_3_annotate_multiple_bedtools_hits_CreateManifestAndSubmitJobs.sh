...
for infile in "${indir}"/*.gridss.filter_svtypes.tsv.rmvCols.tsv; do

  # sample is either family-id (for trios) or vcgs sample-id (for single samples)
...
./gridss_3_annotate_multiple_bedtools_hits_SubmitJobs.sh $out_manifest
