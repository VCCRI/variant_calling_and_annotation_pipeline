...
while read sample infile outdir; do
  ...
  outfile="${outdir}"/"${infile_basename_prefix}".vqsr_intermediate_file

  outfile_indel_recal="${outfile}".indel.recal
  outfile_indel_tranches="${outfile}".indel.tranches
  outfile_indel_rscript="${outfile}".indel.plots.R
  outfile_snp_recal="${outfile}".snp.recal
  outfile_snp_tranches="${outfile}".snp.tranches
  outfile_snp_rscript="${outfile}".snp.plots.R
