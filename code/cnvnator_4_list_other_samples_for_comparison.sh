...
indir=/my/directory/variant_calling_and_annotation_pipeline/working_directory/cnvnator_annotate/*.cnvnator.filter.tsv

final_db=databases/database.cnvnator.allVars.txt
old_db=databases/database.cnvnator.allVars.OLD.txt
