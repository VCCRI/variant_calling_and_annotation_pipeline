...
indir=/my/directory/variant_calling_and_annotation_pipeline/working_directory/manta_annotate/*.manta_diploidSV_withInversions.tsv

final_db=databases/database.manta.allVars.txt
old_db=databases/database.manta.allVars.OLD.txt
