...
indir=/my/directory/variant_calling_and_annotation_pipeline/working_directory/gridss_annotate/*.gridss.filter_svtypes.tsv

final_db=databases/database.gridss.allVars.txt
old_db=databases/database.gridss.allVars.OLD.txt
