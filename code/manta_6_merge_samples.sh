...
indir=/my/directory/variant_calling_and_annotation_pipeline/working_directory/manta_annotate
             ...
             infile_basename_suffix_CHD_singles=.manta.CHD_955_genes.vpot_final_output_file.vpot_gt_0.txt
outfile_basename_suffix_CHD_singles=_"${batch}"__manta.CHD_955_genes.vpot_final_output_file.vpot_gt_0.txt

             infile_basename_suffix_CHD_family=.manta.CHD_955_genes.vpot_final_output_file.txt
outfile_basename_suffix_CHD_family=_"${batch}"__manta.CHD_955_genes.vpot_final_output_file.txt

             infile_basename_suffix_DCM_singles=.manta.DCM_909_genes.vpot_final_output_file.vpot_gt_0.txt
outfile_basename_suffix_DCM_singles=_"${batch}"__manta.DCM_909_genes.vpot_final_output_file.vpot_gt_0.txt

             infile_basename_suffix_DCM_family=.manta.DCM_909_genes.vpot_final_output_file.txt
outfile_basename_suffix_DCM_family=_"${batch}"__manta.DCM_909_genes.vpot_final_output_file.txt
  ...
  for singles_or_family in "singles" "family"; do
    ...
    if [[ $infile_basename_suffix != "" ]]; then
      ...
      if [[ $one_file != '' ]]; then # some files were found in this cohort and singles_or_family, so output a merged file of those files
        ...
        tmphdr="${tmpdir}"/manta_7_merge_samples.temp_manta_hdr.txt
        tmphdr2="${tmpdir}"/manta_7_merge_samples.temp_manta_hdr2.txt
